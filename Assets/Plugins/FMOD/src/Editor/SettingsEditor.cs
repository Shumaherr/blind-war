...
namespace FMODUnity
{
    ...
    public class SettingsEditor : Editor
    {
        ...
        private readonly TreeViewState platformTreeViewState = new();
        ...
        private class ProjectPlatformSelector : PopupWindowContent
        {
            ...
            private readonly GUIContent speakerModeHeader = new("Surround speaker mode:");
            private readonly Vector2 speakerModeSize;

            private readonly GUIContent subdirectoryHeader = new("Output sub-directory:");
