...
namespace FMODUnity
{
    ...
    internal class EditorUtils : MonoBehaviour
    {
        ...
        private static readonly List<Bank> masterBanks = new();
        private static readonly List<Bank> previewBanks = new();
        ...
        public static void FolderMerge()
        {
            ...
            if (merge)
            {
                ...
                foreach (var arch in archs)
                {
                    ...
                    if (AssetDatabase.IsValidFolder("Assets/Plugins/Android/libs/" + arch) && AssetDatabase
                        .FindAssets("", new[] { "Assets/Plugins/Android/libs/" + arch }).Length == 0)
