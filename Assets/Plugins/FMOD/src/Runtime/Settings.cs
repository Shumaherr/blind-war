...
namespace FMODUnity
{
    ...
    public class Settings : ScriptableObject
    {
        ...
        [SerializeField] public List<string> Plugins = new();
        ...
        private readonly Dictionary<BuildTarget, Platform> PlatformForBuildTarget = new();
#endif

        // This is used to find the platform that matches the current Unity runtime platform.
        private readonly Dictionary<RuntimePlatform, List<Platform>> PlatformForRuntimePlatform = new();
        ...
        [SerializeField] private List<Legacy.Platform> MigratedPlatforms = new();
        ...
        private static readonly List<PlatformTemplate> platformTemplates = new();
